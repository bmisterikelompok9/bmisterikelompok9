<?php $__env->startSection('judul', 'Post Yang Sudah Dihapus'); ?>
  ...
  <table class="table table-striped table-hover table-sm table-bordered">
    ...
    <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td>
          <form action="<?php echo e(route('post.kill', $d->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php echo method_field('delete'); ?>
            <a href="<?php echo e(route('post.restore', $d->id)); ?>" class="btn btn-success btn-sm">Restore</a>
...
<?php echo $__env->make('template_backend.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/admin/post/hapus.blade.php ENDPATH**/ ?>