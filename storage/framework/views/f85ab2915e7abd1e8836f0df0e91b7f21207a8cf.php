<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?php echo e(url('/')); ?>">B-Misteri</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo e(url('/')); ?>">BM</a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li class=active><a class="nav-link" href="<?php echo e(url('/')); ?>"><i class="fas fa-fire"></i>
...
</div><?php /**PATH C:\xampp\htdocs\blog\resources\views/template_backend/sidebar.blade.php ENDPATH**/ ?>