...
<body>
		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.html" class="logo"><img src="<?php echo e(asset('img/logo.png')); ?>" alt=""></a>
					</div>
					<!-- /logo -->
	...
	<!-- /HEADER -->
<?php /**PATH C:\laragon\www\Blog-SEO-Laravel\resources\views/template_frontend/head.blade.php ENDPATH**/ ?>