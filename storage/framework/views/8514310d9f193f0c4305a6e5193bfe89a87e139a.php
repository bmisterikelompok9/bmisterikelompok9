...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="post">
            <a class="post-img" href="<?php echo e(route('blog.isi', $d->slug)); ?>"><img src="<?php echo e(asset( $d->gambar )); ?>"
                    height="250" alt=""></a>
            <div class="post-body">
...
<?php echo $__env->make('template_frontend.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/user/home.blade.php ENDPATH**/ ?>